...
import { ActionButton } from "../components/BotaoDeAcao";
import { FokusButton } from "../components/BotaoDeFoco";
import { Timer } from "../components/TempoMinimo";
...
const pomodoro = [
  ...
  },
  {
    ...
    display: "Descanso [Breve]",
  },
  {
    id: "long",
    initialValue: 15,
    image: require('./longo.png'),
    display: "Descanso [Ampliado]",
  },
];
